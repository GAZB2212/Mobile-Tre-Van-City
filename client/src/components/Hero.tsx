...
export default function Hero() {
  return (
    <section className="relative bg-background text-white py-16 sm:py-24 md:py-32 lg:py-40 overflow-hidden">
      {/* Video Background */}
      <video 
        autoPlay 
        loop 
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 sm:mb-8 leading-tight" data-testid="text-hero-headline">
