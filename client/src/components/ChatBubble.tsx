  ...
  const mutation = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description: "We couldn't send your message. Please call us on 0151 203 8500.",
      });
    },
  });
          ...
          <div className="bg-[#8bc440] px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-[#191919]/70">Mobile Tyre Van City</p>
              </div>
            </div>
            <Button
              size="icon"
          ...
          {submitted ? (
            ...
            <div className="p-6 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs text-muted-foreground flex items-center gap-1">
                <Phone className="w-3 h-3" /> Or call us: 0151 203 8500
              </p>
              <Button
                variant="outline"
                size="sm"
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    Or call us: <a href="tel:01512038500" className="underline">0151 203 8500</a>
                  </p>
                </form>
              </Form>
            </div>
