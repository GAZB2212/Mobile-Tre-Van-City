  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="Expert advice, industry news, and practical guides for mobile tyre van operators. Tips on growing your mobile tyre business from the team at Mobile Tyre Van City."
        canonical="/blog"
        ...
        <section className="py-12 px-4 border-b border-border">
          <div className="container mx-auto max-w-6xl">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl md:text-4xl font-bold" data-testid="heading-blog">The MTVC Blog</h1>
            </div>
