...
export const vanModels: VanModel[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Absolutely. We accept customer-supplied vehicles for conversion. We recommend the Transit be no older than a 2018 plate and have full service history. Before committing to a conversion, bring it to our Wirral workshop so our team can inspect it and confirm it is suitable.",
      },
      {
