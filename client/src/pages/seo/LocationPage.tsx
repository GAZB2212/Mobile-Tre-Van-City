...
export default function LocationPage() {
  ...
  const localBusinessSchema = {
    ...
    address: {
      ...
      addressLocality: "Bromborough, Wirral",
      postalCode: "CH62 3QL",
      addressCountry: "GB",
    },
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      ...
                      <a href="tel:01512038500" className="text-foreground font-medium">0151 203 8500</a>.
                    </p>
        ...
        <section className="bg-[#8bc440] py-12">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <p className="text-[#191919]/70 mb-6 max-w-xl mx-auto">
              Use our online configurator to build your perfect van, or call our team on 0151 203 8500 to discuss your requirements.
            </p>
