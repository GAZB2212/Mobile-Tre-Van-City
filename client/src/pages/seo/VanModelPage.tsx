...
export default function VanModelPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: van.displayName, item: `https://www.mobiletyrevancity.co.uk/van-conversions/${van.slug}` },
    ],
  };
        ...
        <section className="bg-[#8bc440] py-12">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <p className="text-[#191919]/70 mb-6 max-w-xl mx-auto">
              Use our online configurator to choose your equipment pack, upgrades, and get an instant quote — or call us on 0151 203 8500.
            </p>
