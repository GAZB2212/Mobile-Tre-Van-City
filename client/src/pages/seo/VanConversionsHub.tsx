...
const benefits = [
  "All conversions fully built in-house at our Wirral workshop",
...
export default function VanConversionsHub() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.mobiletyrevancity.co.uk/" },
      { "@type": "ListItem", position: 2, name: "Van Conversions", item: "https://www.mobiletyrevancity.co.uk/van-conversions" },
    ],
  };
        ...
        <section className="bg-[#8bc440] py-12">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <p className="text-[#191919]/70 mb-6 max-w-xl mx-auto">
              Our team will help you choose the right base vehicle and equipment pack for your budget and business. Call us on 0151 203 8500 or use the configurator to get a quote online.
            </p>
