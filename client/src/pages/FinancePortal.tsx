...
export default function FinancePortal() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Decision saved", description: "The MTVC team has been notified." });
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs leading-tight hidden sm:block">Mobile Tyre Van City</p>
            </div>
          </div>
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 overflow-y-auto p-4 sm:p-6 outline-none">
        ...
        {!isLoading && deals.length === 0 && (
          <div className="text-center py-20 text-muted-foreground" data-testid="empty-state">
            ...
            <p className="text-sm mt-1">Deals will appear here once the MTVC team submits applications to you.</p>
          </div>
        )}
      </main>
          ...
          {selectedDeal && (
            <div className="flex flex-col h-full">
              ...
              <div className="space-y-4 flex-1">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="fp-notes">Notes for MTVC Team</Label>
                  <Textarea
                    id="fp-notes"
                    value={newNotes}
                ...
                <div className="flex gap-2 pt-1">
                  ...
                  >
                    {updateMutation.isPending ? "Saving..." : "Save Decision & Notify MTVC"}
                  </Button>
                </div>
