...
import { CheckCircle, XCircle, AlertCircle, Loader2, Phone, ZoomIn } from "lucide-react";
  ...
  if (submitted || alreadyAnswered) {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        <Header />
        <main className="flex-1 flex items-center justify-center px-4 py-16">
          <Card className="max-w-lg w-full" data-testid="card-artwork-submitted">
            <CardContent className="py-12 text-center space-y-4">
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          {submitMutation.isError && (
            <p className="text-sm text-destructive text-center" data-testid="text-error">
              Something went wrong. Please try again or call us on 0151 203 8500.
            </p>
          )}
