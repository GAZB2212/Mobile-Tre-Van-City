...
export const kitCatalog: KitSeedEntry[] = [
  {
    ...
    sku: "MTVC-KIT-001",
    skuComponents: [
      { sku: "MTVC-EQP-T1000", description: "T1000 Pro Tyre Changer", quantity: 1 },
      { sku: "MTVC-EQP-MSPIN", description: "Mini Spin Wheel Balancer", quantity: 1 },
      { sku: "MTVC-AIR-COMP-STD", description: "Standard Air Compressor", quantity: 1 },
      { sku: "MTVC-EQP-TOOLS-STD", description: "Basic Tool Set", quantity: 1 },
    ],
  },
  {
    ...
    skuComponents: [
      { sku: "MTVC-EQP-T1000", description: "T1000 Pro Tyre Changer", quantity: 1 },
      { sku: "MTVC-EQP-MSPIN", description: "Mini Spin Wheel Balancer", quantity: 1 },
      { sku: "MTVC-AIR-COMP-E6", description: "Euro 6 Compatible Air System", quantity: 1 },
      { sku: "MTVC-EQP-TOOLS-STD", description: "Basic Tool Set", quantity: 1 },
    ],
  },
  {
    ...
    sku: "MTVC-KIT-003",
    skuComponents: [
      { sku: "MTVC-EQP-T2000", description: "T2000 Pro Tyre Changer", quantity: 1 },
      { sku: "MTVC-EQP-MSPIN", description: "Mini Spin Wheel Balancer", quantity: 1 },
      { sku: "MTVC-AIR-COMP-HC", description: "High-Capacity Air Compressor", quantity: 1 },
      { sku: "MTVC-EQP-TOOLS-PRO", description: "Professional Tool Set", quantity: 1 },
    ],
  },
  {
    ...
    skuComponents: [
      { sku: "MTVC-EQP-T2000", description: "T2000 Pro Tyre Changer", quantity: 1 },
      { sku: "MTVC-EQP-MSPIN", description: "Mini Spin Wheel Balancer", quantity: 1 },
      { sku: "MTVC-AIR-COMP-HCE6", description: "Euro 6 Compatible High-Capacity Air System", quantity: 1 },
      { sku: "MTVC-EQP-TOOLS-PRO", description: "Professional Tool Set", quantity: 1 },
    ],
  },
];
