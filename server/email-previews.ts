...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  ...
  { id: 'spec-summary-single', label: 'Spec Summary (Single Van)', description: 'Sent to customer after admin discusses their specification', subject: `Your Van Conversion Summary – Ref #${REF} – Mobile Tyre Van City`, recipient: 'customer', group: 'Spec' },
  { id: 'spec-summary-comparison', label: 'Spec Summary (Comparison)', description: 'Spec summary with two options for the customer to choose between', subject: `Your Van Conversion Options – Ref #${REF} – Mobile Tyre Van City`, recipient: 'customer', group: 'Spec' },
  ...
  { id: 'quote-spec-summary-single', label: 'Quote Spec Summary (Single Van)', description: 'Full spec summary sent after admin call — with discount, bespoke extras, and approval buttons', subject: `Your Van Conversion Summary – Ref #${REF} – Mobile Tyre Van City`, recipient: 'customer', group: 'Quote' },
  { id: 'quote-spec-summary-comparison', label: 'Quote Spec Summary (Comparison)', description: 'Two-option A/B spec summary — shows Option B with a CHOSEN badge after the customer selects', subject: `Your Van Conversion Options – Ref #${REF} – Mobile Tyre Van City`, recipient: 'customer', group: 'Quote' },
