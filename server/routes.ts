...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Register customer account (post-quote)
  app.post("/api/customer/register", async (req, res) => {
    try {
      ...
      // Create customer account (not admin)
      ...
      // Link any existing quotes to this customer account
  ...
  // Get customer's quotes (authenticated customers only)
  app.get("/api/customer/quotes", isAuthenticated, async (req, res) => {
    try {
